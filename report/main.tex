...
This is done by adding a callback function to the CPLEX environment that is called after each iteration of the optimization process.
The callback function checks for subtours in the solution and adds the corresponding subtour elimination constraints to the model.
