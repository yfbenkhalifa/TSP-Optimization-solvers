...
The Mathheuristics are a class of optimization algorithms that combine mathematical programming techniques with heuristics to solve combinatorial optimization problems.
They are typically used to find high-quality solutions to difficult problems that cannot be solved optimally using traditional methods.
In our case we will in particular focues on the Local Branching and Fixed Branching Mathheuristics.
